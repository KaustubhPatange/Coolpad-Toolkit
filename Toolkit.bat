...
echo ====================================================================================
echo.
echo OPTION 99 IS A BASIC TOOLKIT FOR ANY COOLPAD DEVICE. YOU CAN MAKE BACKUPS, INSTALL
echo APK FILES, MAKE A LOGCAT, VIEW DEVICE INFO, OPEN A COMMAND PROMPT AND OTHER TASKS.
echo.
...
echo.
echo  COOLPAD DEVICE SUPPORTED                       COOLPAD DEVICE NOT SUPPORTED YET
echo  ------------------------                       --------------------------------
echo.
echo  01. Coolpad Note 3 [Lollipop/Marshmallow]       NS. Coolpad Mega 2.5D
echo  02. Coolpad Note 3 Lite                         NS. Coolpad Max
echo      [Lollipop/Marshmallow]                      NS. Coolpad Note 5(hope for good)
echo  03. Coolpad Note 3 Plus                                            
echo.                                                
echo.
echo NOTE:- IF YOUR DEVICE IS NOTE SUPPORTED, YOU CAN STILL USE THE BASIC TOOLKIT AS 
ECHO ------ ALL THESE ABOVE ARE PLUGINGS FOR RECOVERIES, CUSTOM ROM, THEME, STOCK ROM
ECHO LINKS AND OTHER FEATURE. HOWEVER YOU CAN STILL FLASH OR ROOT ANY COOLPAD DEVICE
ECHO BECAUSE THIS TOOLKIT IS UNIVERSAL COOLPAD TOOLKIT.
ECHO IF YOUR DEVICE IS NOT LISTED ABOVE, CONTACT ME :)
ECHO.
echo  Key: NS - Not Supported Yet [will be added]
echo.
echo  99. Go straight to Main Menu with basic android toolkit       [any coolpad device]
echo  DR. Install drivers to work with android devices       [for adb/fastboot/recovery]
echo  I.  Display connected Device Information     [if plugged in and drivers installed]
echo  D.  Go to The toolkit Official Webpage       
echo  R.  Refresh Screen                          CP. Open a Command Prompt
echo  C.  Contact Me :)                           CH. Check for Updates
echo  T.  TroubleShoot                             S. Sync Toolkit [Synchronise Modules]
echo  A.  Autmatically Detect your device ^& Download the modules..
echo  DO. Donate Me :)
echo.
echo  X.  EXIT
echo.
ECHO IF YOU FIND ANY BUG, WANT TO REPORT ME SOMETHING, HELP ME IN MAKING THESE MODULES,
ECHO WANT TO GIVE ANY SUGGESTIONS, CONTACT SUPPORT, ETC. YOU CAN CONTACT ME FROM ABOVE
ECHO OPTIONS "C" (WITHOUT QUOTES :0)
echo.
echo ====================================================================================
echo  You last used the Toolkit with: %MODEL%
echo ====================================================================================
echo.
SET /P menuselection=[*] Make A Choice:- 
...
"%~dp0tools\wget.exe" -O temp/updatefile.7z %filelink1% --no-check-certificate -q
cd temp
